...
import 'package:save_heaven/features/donation/presentation/cubit/send_message_cubit.dart';
      ...
      child: Container(
        ...
        child: Wrap(
          children: [
            ...
            /// ✅ Attach File Row
            BlocBuilder<SendMessageCubit, String?>(
              builder: (context, fileName) {
                return Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(fileName ?? "Attach File", style: TextStyle(color: Colors.black54)),
                    ),
