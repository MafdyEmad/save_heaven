            ...
            body: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: buildTitle("Donation"),
                ),

                SizedBox(height: width * 0.04),
                Text(
                  "Donate to Orphan Sponsorship Projects",
                  style: TextStyle(color: Colors.green, fontWeight: FontWeight.bold, fontSize: width * 0.04),
                ),
                Padding(
                  padding: EdgeInsets.symmetric(horizontal: width * 0.06, vertical: width * 0.01),
                  child: Text(
                  ...
                  child: BlocBuilder<DonationCubit, List<OrphanageModel>>(
                    builder: (context, orphanages) {
                      ...
                      return GridView.builder(
                        ...
                        itemBuilder: (_, index) => OrphanageCard(model: orphanages[index]),
                      );
                    },
                  ),
                ),
